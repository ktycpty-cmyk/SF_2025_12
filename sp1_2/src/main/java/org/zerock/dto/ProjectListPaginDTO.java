...
@Data
public class ProjectListPaginDTO {

	private List<ProjectDTO> projectDTOList; // 전제 목록
	...
	public ProjectListPaginDTO(List<ProjectDTO> projectDTOList, int totalCount,
			int page, int size, String types, String keyword, String category) {

		this.projectDTOList = projectDTOList; // 현재 페이지에 출력할 게시글 목록
		...
		this.category = category; // 카테고리 (CODING/JAPANESE)
